...
def make_modes(ticks):
    anims = [
        ...
        [
            'Speed - Medium',
            ('Blinke', [0x73, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07]),
        ...
        [
            'Tilt X - Low',
            ('Tracer', [0xB2, 0x08, 0x0B, 0x0E, 0x11, 0x14, 0x17, 0x1A, 0x1D]),
            ('Tracer', [0xB6, 0x08, 0x0B, 0x0E, 0x11, 0x14, 0x17, 0x1A, 0x1D]),
        ],
        [
            'Tilt X - Medium',
            ('Candy', [0x08, 0x0A, 0x0C, 0x0E, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1A, 0x1C, 0x1E]),
            ('Candy', [0x08, 0x0C, 0x00, 0x0E, 0x12, 0x00, 0x14, 0x18, 0x00, 0x1A, 0x1E, 0x00]),
        ],
        [
            'Tilt X - High',
            ('Edge', [0x08, 0x1F, 0x1E, 0x9D, 0x9C, 0xDB, 0xDA, 0xD9, 0xD8, 0x00, 0x00, 0x00]),
            ('Edge', [0x18, 0x19, 0x1A, 0x9B, 0x9C, 0xDD, 0xDE, 0xDF, 0xC8, 0x00, 0x00, 0x00]),
        ],
        [
            'Tilt Y - Low',
            ('Chase', [0x09, 0x11, 0x19, 0x0B, 0x13, 0x1B, 0x0D, 0x15, 0x1D, 0x0F, 0x17, 0x1F]),
            ('Chase', [0x1F, 0x17, 0x0F, 0x1D, 0x15, 0x0D, 0x1B, 0x13, 0x0B, 0x19, 0x11, 0x09]),
        ],
        [
            'Tilt Y - Medium',
            ('Ribbon', [0x08, 0x61, 0x63, 0x00, 0x10, 0x69, 0x6B, 0x00, 0x18, 0x71, 0x73, 0x00]),
            ('Ribbon', [0x08, 0x08, 0x08, 0x00, 0x10, 0x10, 0x10, 0x00, 0x18, 0x18, 0x18, 0x00]),
        ],
        [
            'Tilt Y - High',
            ('Comet', [0x08, 0x0C, 0x10, 0x14, 0x18, 0x1C]),
            ('Comet', [0x0A, 0x0E, 0x12, 0x16, 0x1A, 0x1E]),
        ],
        [
            'Flip Z - Low',
        ...
        [
            'Flip Z - High',
            ('Morph', [0x08, 0x0C, 0x10]),
            ('Morph', [0x10, 0x14, 0x18]),
        ],
    ]
